...
class TitleState extends MusicBeatState
{
	...
	function startIntro()
	{
		...
		ngSpr = new FlxSprite(0, FlxG.height * 0.52).loadGraphic(Paths.image('d&blogo'));
		ngSpr.visible = false;
		...
		if(!closedState)
		{
			...
			switch (sickBeats)
			{
				...
				case 13:
					deleteCoolText();
				case 14:
					addMoreText('dave & bambi');
				case 15:
					addMoreText('disheartening');
				case 16:
					addMoreText('betrayal'); // credTextShit.text += '\nFunkin';
